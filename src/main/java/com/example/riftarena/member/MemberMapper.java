...
public interface MemberMapper {
 ...
 List<Map<String,Object>> byIds(@Param("ids") List<Long> ids); List<Map<String,Object>> hallOfFame();
 ...
 List<Map<String,Object>> championStats(Long memberId); List<Map<String,Object>> inhouseChampionStats(Long memberId);
 List<Map<String,Object>> synergy(Long memberId); List<Map<String,Object>> recentMatches(Long memberId);
}
