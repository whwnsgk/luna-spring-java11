...
public class MemberService {
 ...
 @Transactional public Map<String,Object> refreshRiot(Long id){
  ...
  List<Map<String,Object>> champions=(List<Map<String,Object>>)data.get("champions"); if(champions!=null)for(Map<String,Object> c:champions){c.put("memberId",id);mapper.insertChampionStat(c);} return detail(id,null);
 }
